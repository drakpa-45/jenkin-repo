        ...
        <div class="content__inner">
            <div class="card" id="appNoSection" style="height: 240px">
                ...
                <div class="card-header">
                    <span class="card-title">Print Sowing Permit</span>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <button type="button" class="btn text-white" onclick="showSowingPermit()" style="background-color: #d0802b"><a href="#" class="text-white">Submit</a></button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table cellspacing="3" cellpadding="3" width="100%" border="0" id="tab_id">
                        <tr>
                            ...
                            <td style="text-align:center;">
                                ...
                                <strong style="font-size:16px;">Sawing Permit</strong><br/>
                            </td>
                        ...
                        <div class="card-body">
                            <div class="form-group row mb-2">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-control-sm">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="modeOfSawing" readonly>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-control-sm">
                                    <label class="form-label">Name of sawmill/operator:</label>
                                    <input type="text" class="form-control form-control-sm" id="name_of_Sawmill" readonly>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-control-sm">
                                    <label class="form-label">License/Registration No. :<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control form-control-sm" id="licenseNo" readonly>
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-control-sm">
                                    <label class="form-label">Location of Sawmill:</label>
                                    <input type="text" class="form-control form-control-sm" id="location_of_Sawmill"  readonly>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-control-sm">
                                    <label class="form-label">Sawing rate:</label>
                                    <input type="text" class="form-control form-control-sm" id="sawing_Rate" readonly>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-control-sm">
                                    <label class="form-label">Officer on Duty</label>
                                    <input type="text" class="form-control form-control-sm" id="officerOnDuty" readonly>
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-control-sm">
                                    <label class="form-label">Sawing Permit Date</label>
                                    <input type="text" class="form-control form-control-sm" id="sawingPermitDate" readonly>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-control-sm">
                                    <label class="form-label">Validity of Permit</label>
                                    <input type="text" class="form-control form-control-sm" id="permit_Validity_Date" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                           <%-- <div style="overflow-x: auto;white-space: nowrap;">
                            ...
                            <div style="overflow-x: auto;white-space: nowrap;">
                                <table class="table table-bordered" id="cosdtmoItmoInfoTbls">
                                    <thead style="background-color:#478d86">
                                    <tr>
                                        <th class="text-white">Sl No#</th>
                                        <th class="text-white">Produce</th>
                                        <th class="text-white">Species Name</th>
                                        <th class="text-white">Location</th>
                                        <th class="text-white">Log/Block</th>
                                        <th class="text-white">Length</th>
                                        <th class="text-white">Breath</th>
                                        <th class="text-white">Girth</th>
...
<script language="javascript" type="text/javascript">
    ...
    function showSowingPermit(){
        var appNo = $('#applicationNo').val();
        $.ajax({
            type : "GET",
            url : '${pageContext.request.contextPath}/public/initiate/fetchSowingPermitDtls?appNo='+appNo,
            data: $('form').serialize(),
            cache : false,
            success : function(res) {
                if(res.status=='1'){
                    ...
                    $('#sawingPermitDate').val(dto.sawingPermitDate);
                    $('#name_of_Sawmill').val(dto.name_of_Sawmill);
                    $('#licenseNo').val(dto.licenseNo);
                    $('#location_of_Sawmill').val(dto.location_of_Sawmill);
                    $('#sawing_Rate').val(dto.sawing_Rate);
                    $('#permit_Validity_Date').val(dto.permit_Validity_Date);
                    $('#modeOfSawing').val(dto.mode_of_Swing_Desc);
                    $('#officerOnDuty').val(dto.officer_on_Duty);
                    ...
                    var cosdtmoItmoDtls=dto.cosdtmoItmoList;
                    if(timberDtls.length>0){
                        ...
                        tr = tr +"<tr>" +
                        "<td colspan='5' class='text-center'>Total Amount = (Royalty Amount + Permit Fee)</td>" +
                        "<td>"+timberDtls[0].total_Royalty+"</td>"+
                        "</tr>";
                        productTbls.find('tbody').append(tr);
                    }

                    var cosdtmoItmoInfoTbls = $('#cosdtmoItmoInfoTbls');
                    cosdtmoItmoInfoTbls.find('tbody').find('.noRecord').remove();

                    if(cosdtmoItmoDtls.length>0){
                        var tr = '';
                        var totalVolume =0;
                        for (var k in cosdtmoItmoDtls) {
                            n++;
                            totalVolume=totalVolume+cosdtmoItmoDtls[k].total_Volume;
                            tr = tr + "<tr><td>"+ n +"</td>" +
                            "<td>" + cosdtmoItmoDtls[k].produce + "</td>" +
                            "<td>" + cosdtmoItmoDtls[k].species_Name + "</td>" +
                            "<td>" + cosdtmoItmoDtls[k].location_of_Timber + "</td>" +
                            "<td>" + cosdtmoItmoDtls[k].logBlock + "</td>" +
                            "<td>" + cosdtmoItmoDtls[k].length + "</td>" +
                            "<td>" + cosdtmoItmoDtls[k].breath + "</td>" +
                            "<td>" + cosdtmoItmoDtls[k].girth + "</td>" +
                            "<td>" + cosdtmoItmoDtls[k].quantity + "</td>" +
                            "<td>" + cosdtmoItmoDtls[k].unit + "</td>" +
                            "<td>" + cosdtmoItmoDtls[k].total_Volume + "</td>" +
                            "</tr>";
                        }
                        tr = tr +"<tr>" +
                        "<td colspan='10' class='text-center'>Total Volume</td>" +
                        "<td>"+totalVolume+"</td>"+
                        "</tr>";
                        $('#totalVolume').val(totalVolume);
                        cosdtmoItmoInfoTbls.find('tbody').append(tr);
                    }
                }else{
                    warningMsg(res.text);
                    $("#appNoSection").show();
