        ...
        <form action="#" id="personalForm" method="post">
                            ...
                            <div class="table-responsive">
                                <table id="attachment" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-outline-primary" type="button" onclick="viewAttachment('<%=attachment.get(a).getuUID()%>','download')"><i class="fa fa-download"></i> Download</button>
                                        </td>
                                    </tr>
                                    <%}%>
                                    </tbody>
            ...
            <div class="card mt-2">
                ...
                <div class="card-body" id="timberSection">
                    ...
                    <%}%>
                    <input type="hidden" id="statusId" value="<%=App_Details.getStatus_Id()%>">
                    <input type="hidden" id="productName" value="<%=product.get(0).getProduct_Catagory()%>">
                    <div class="form-group row mb-2">
                          <div class="form-group col-lg-12 mx-auto d-flex align-items-center my-4">
                              <div class="border-bottom w-100 ml-5" style="border: 1px solid#888;"></div>
                              ...
                              <div style="overflow-x: auto;white-space: nowrap;">
                                  <table class="table table-bordered" id="productTbls">
                                      ...
                                      <tr>
                                          ...
                                          <%}%>
                                          <td><input class="form-control" type="number" id="allot_Quantity_<%=a%>" name="timberDetails[<%=a%>].allot_Quantity" value="0"  min="1"/>&nbsp;<span id="errmsg<%=a%>" class="text-danger"></span></td>
                                      </tr>
                                      <%}%>
                                      </tbody>
                                  </table>
                ...
                <div class="card-body border-dark">
                    ...
                    <div class="form-group text-right sub_button">
                        <div class="col-md-12 col-sm-12-col-lg-12 col-xs-12 form-control-sm">
                            <button class="btn fa-pull-right text-white" id="btn_submit_final_form" disabled="true" style="background-color: #236F67;" onclick="approveCFO('<%=App_Details.getApplication_Number()%>')"
    ...
    <script>
        ...
        function approveCFO(appNo) {
            ...
            if(range_id !="0"){
                $.ajax({
                    type : "POST",
                    url : '${pageContext.request.contextPath}/gewog/cfoApprove?remarks=' + remarks + '&appNo='+appNo+'&statusId='+statusId+'&productName='+productName,
                ...
                $('#range_err').html('Choose range');
                $('#range_err').show();
                $('#range_err').delay(2000).fadeOut('slow');
            }
        }
