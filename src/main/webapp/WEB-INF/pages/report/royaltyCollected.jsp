...
<%-- Created by IntelliJ IDEA. User: Pema Drakpa Date: 16/01/2023 Time: 9:57 AM To change this template use File | Settings | File Templates. --%>
...
<section class="content">
    <div class="content__inner"><br/>
        <div class="card">
            <div class="card-header badge-secondary"><b>Rural Timber Permit / </b>Amount Collected</div>
                            ...
                            <div class="card-body">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        ...
                                        <select class="form-control col-6" name="cons_Type" id="cons_Type_id">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        <label><b>Range Office:</b></label>
                                        <select name="allot_Range_Officer" class="form-control col-6" id="rangeId">
                                            <option value="ALL">ALL</option>
                                            <c:forEach var="plist" items="${rangeList}" varStatus="counter">
                                        ...
                                        <table class="table table-bordered" id="reportTbls">
                                            ...
                                            <tr>
                                               ...
                                               <%-- <td style="width:3px">Village</td>--%>
                                                ...
                                                <td style="width:3px">Amount Collected</td>
                                                <td style="width:3px">Mode of Payment</td>
        ...
        if ($('#divisionBase').val() == "divisionBase") {
            if (validateDetails() == true) {
                ...
                $.ajax({
                    ...
                    type: 'GET',
                    data: {division_Park_Id:division_ID,dzongkhag_Name:dzongkhag,gewog_Name:geog,from_Date:from_Date,to_Date:to_Date,type:type,cons_Type:Construction_type,product_category:product_Category,rangeId:rangeId},
                    success: function (res) {
                        ...
                        for(var j=0;j<res.dto.length;j++){
                            ...
                            +'<td>'+res.dto[j].amount_collected+'</td>'
                            +'<td>'+res.dto[j].payment_Mode+'</td>'
