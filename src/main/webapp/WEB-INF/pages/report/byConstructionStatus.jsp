...
<section class="content">
    <div class="content__inner"><br/>
        <div class="card">
            <div class="card-header badge-secondary"><b>Rural Timber Permit / </b> By Construction Status</div>
            <div class="card-body"><span class="text-danger"> NOTE: Label which are marked with * are mandatory fields, you cannot proceed further without those fields. <a href="#" data-toggle="tooltip" data-placement="top" title=""
                ...
                <div class="row form-group" style="margin-top:-10px;">
                    <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                        <% if (userBean.getCurrentRole().getRoleName().equalsIgnoreCase("GUP")){%>
                        <form action="#" id="RuralTimberReport" method="get">
                            ...
                            <div class="card-body">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        <label><b>Construction Status:</b></label>
                                ...
                                <%--<div class="form-group row mb-4">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        ...
                                        <select class="form-control col-6" name="Product_Desc" id="gup_product_Catagory"&lt;%&ndash; onchange="getDropdown(this.value,'product_category','product_Catagory')"&ndash;%&gt;>
                                            <option value="ALL">ALL</option>
                                            &lt;%&ndash;<c:forEach var="tlist" items="${timber_Form}" varStatus="counter"> <option  value="${tlist.certify_Tag}">${tlist.header_Name}</option> </c:forEach>&ndash;%&gt;
                                        </select>
                                    </div>
                                </div>--%>
                                    ...
                                    <div style="overflow-x: auto;white-space: nowrap;">
                                        <table class="table table-bordered" id="reportTbls">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:3px">Construction Status</td>
...
<script language="javascript" type="text/javascript">
    ...
    function generateReportGup() {
        ...
        $.ajax({
            ...
            type: 'GET',
            data: {locationId:locationId,cons_Type:Construction_type,product_Category:product_Category,from_Date:from_Date,to_Date:to_Date,type:type,construction_status:construction_status},
            success: function (res) {
                ...
                for(var j=0;j<res.dto.length;j++){
                    ...
                    +'<td>'+res.dto[j].construction_status+'</td>'
