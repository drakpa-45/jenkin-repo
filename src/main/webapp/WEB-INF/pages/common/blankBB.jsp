...
<%--<div class="cotn_principal">
        ...
        <div class="cont_login">
            <div class="cont_info_log_sign_up">
                <div class="col_md_login">
                    <div class="cont_ba_opcitiy">
                        ...
                        <p></p>
                        <button class="btn_login" onclick="ssoLogin()">SSO</button>
                    </div>
                </div>
                <div class="col_md_sign_up">
                    <div class="cont_ba_opcitiy">
                        ...
                        <button class="btn_sign_up" onclick="passwordLessLogin()">NDI</button>
                    </div>
                </div>
            </div>
            ...
            <div class="cont_forms" >
                ...
                <div class="cont_form_login">
                    <a href="#" onclick="ssoLogin()" ><i class="material-icons"></i></a>
                    <h2>SSO</h2>
                ...
                <div class="cont_form_sign_up">
                    <a href="#" onclick="passwordLessLogin()"><i class="material-icons"></i></a>
                    <h2>NDI</h2>
                    <input type="text" placeholder="Username" />
                    <input type="password" placeholder="Password" />
    ...
    <div class="container">
        <div class="form-group row">
            <div class="col-lg-3 col-md-3 col-sm-3 mt-3"></div>
            <div class="col-lg-5 col-md-5 col-sm-5 mt-3"><canvas id="qrcode"></canvas></div>
            <div class="col-lg-4 col-md-4 col-sm-4 mt-3"></div>
        </div>
    </div>
</div>--%>
<div class="container">
    <div class="row">
        <div class="social-box" id="socialBx">
            <div class="row mg-btm">
                <div class="col-md-12">
                    <a href="#"onclick="passwordLessLogin()" class="btn btn-block btn-bg">
                        <img src="<c:url value="/resources/images/NDI logonoBG.png"/>" style="width: 35px; height: 35px"> Login With Bhutan NDI
                    </a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <a href="#" class="btn btn-block btn-bg" >
                        <i class="icon-twitter"></i>Login With SSO
                    </a>
                </div>
            </div>
        </div>
