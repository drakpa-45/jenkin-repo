        ...
        <div class="content__inner">
            <div class="card" id="appNoSection" style="height: 240px;">
                ...
                <div class="card-header">
                    <span class="card-title">Print Allotment Order</span>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <button type="button" class="btn text-white" onclick="showAllotmentOrder()" style="background-color: #d0802b"><a href="#" class="text-white">Submit</a></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <table cellspacing="3" cellpadding="3" width="100%" border="0" id="tab_id">
                        <tr>
                            ...
                            <td style="text-align:center;">
                                ...
                                <strong style="font-size:16px;">Allotment Order</strong><br/>
                            </td>
                        ...
                        <div class="card-body">
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-control-sm">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="allot_Area" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive text-nowrap text-center">
                    <a href="#" class="text-white"> <input type="button" class="btn btn-outline-warning" value="GENERATE" id="print_id" name="print" onclick="generateAllotmentOrderPDF()"/></a>
                </div>
            </div>
        </div>
    </div>
...
<script language="javascript" type="text/javascript">
    function showAllotmentOrder(){
        var appNo = $('#applicationNo').val();
        $.ajax({
            type : "GET",
            url : '${pageContext.request.contextPath}/public/initiate/fetchAllotmentDtls?appNo='+appNo,
            data: $('form').serialize(),
            cache : false,
            success : function(res) {
                if(res.status=='1'){
                    ...
                    if(timberDtls.length>0){
                        ...
                        tr = tr +"<tr>" +
                        "<td colspan='4' class='text-center'>Service Fee</td>" +
                        "<td >10</td>" +
                        "</tr>";
                        tr = tr +"<tr>" +
                        "<td colspan='4' class='text-center'>Total Amount = (Royalty Amount + Service Fee)</td>" +
