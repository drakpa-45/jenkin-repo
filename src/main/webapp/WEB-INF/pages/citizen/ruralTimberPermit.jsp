                                ...
                                <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-success" onclick="submit_online_timber()">Yes</button>
...
<script language="javascript" type="text/javascript">
    ...
    function validatePersonal() {
        ...
        if ($('#cons_Approval_No').val() == "" && cons_type =="n") {
            $('#Approval_err').html('Construction approval number is mandatory');
            $('#Approval_err').show();
            $('#Approval_err').delay(2000).fadeOut('slow');
            returnVal = false;
        }
        return returnVal;
    }
...
//        }
    ...
    function submit_online_timber(){
        ...
        $.ajax({
            type : "POST",
            url : '${pageContext.request.contextPath}/public/loadpagetoemptylayout/saveOnlineTimberPermit',
