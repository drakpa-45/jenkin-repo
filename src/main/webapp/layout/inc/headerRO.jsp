                ...
                <div class="dropdown">
                    <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown" style="margin-top:-2px;">
                        ...
                        <span class="ml-2 d-none d-lg-block">
                             <%if (userBean.getCurrentRole().getRoleName().equalsIgnoreCase("Beat Officer") || userBean.getCurrentRole().getRoleName().equalsIgnoreCase("Range Officer") ){%>
                            <small class="text-white d-block mt-1"><%=userBean.getFullName().replaceAll("null", "")%></small>
                                 <small class="text-white d-block mt-1">Range Officer</small>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item active pr-4">
                                <a class="nav-link" style="color:#ffffff;" href="<c:url value="/common/redirect">
                                <c:param name="userId" value="<%=userBean.getCurrentRole().getRoleName()%>"/>
                            ...
                            <li class="nav-item pr-4">
                                <a href="javascript:void(0)" class="nav-link" style="color:#ffffff;"
                                   data-toggle="dropdown"><i class="fa fa-chart-bar"></i> &nbsp;Generate Reports <i class="fa fa-chevron-down"></i></a>
                            ...
                            <li class="nav-item pr-4">
                                <a href="${pageContext.request.contextPath}/rangeOfficer/checkForBalc" class="nav-link" style="color:#ffffff;"> <i class="fa fa-eye"></i>&nbsp;Check For Balance</a>
                            </li>
                            <li class="nav-item pr-4">
