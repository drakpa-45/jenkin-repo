...
import bt.gov.ditt.dofps.entitiy.CosdtmoItmo;
import bt.gov.ditt.dofps.entitiy.MarkingInformationEntity;

import java.util.Date;
import java.util.List;

/**
 * Created by Pema Drakpa on 2/6/2020.
 */
public class WorkFlowDto {
    ...
    private List<LandDetailsDto> landDetailsDtos;
    private List<MarkingInformationEntity> markingInformationEntityList;
    private List<CosdtmoItmo> cosdtmoItmoList;
    private Integer thram_No;
    ...
    private String app_Marking_Schedule_Date;
    private String sawingPermitDate;

    private String construction_Site;
    private String awayFrom_B_Thromde;
    ...
    private String permit_Validity_Date;
    private String officer_on_Duty;
    ...
    public List<LandDetailsDto> getLandDetailsDtos() {
        return landDetailsDtos;
    }

    public void setLandDetailsDtos(List<LandDetailsDto> landDetailsDtos) {
        this.landDetailsDtos = landDetailsDtos;
    }

    public Integer getThram_No() {
        return thram_No;
    }

    public void setThram_No(Integer thram_No) {
    ...
    public String getApp_Marking_Schedule_Date() {
        return app_Marking_Schedule_Date;
    }

    public void setApp_Marking_Schedule_Date(String app_Marking_Schedule_Date) {
        this.app_Marking_Schedule_Date = app_Marking_Schedule_Date;
    }

    public String getSawingPermitDate() {
        return sawingPermitDate;
    }

    public void setSawingPermitDate(String sawingPermitDate) {
        this.sawingPermitDate = sawingPermitDate;
    }
    ...
    public String getAwayFrom_B_Thromde() {
        return awayFrom_B_Thromde;
    }

    public void setAwayFrom_B_Thromde(String awayFrom_B_Thromde) {
        this.awayFrom_B_Thromde = awayFrom_B_Thromde;
    }
    ...
    public List<CosdtmoItmo> getCosdtmoItmoList() {
        return cosdtmoItmoList;
    }

    public void setCosdtmoItmoList(List<CosdtmoItmo> cosdtmoItmoList) {
        this.cosdtmoItmoList = cosdtmoItmoList;
    }

    public String getPermit_Validity_Date() {
        return permit_Validity_Date;
    }

    public void setPermit_Validity_Date(String permit_Validity_Date) {
        this.permit_Validity_Date = permit_Validity_Date;
    }
    ...
    public String getOfficer_on_Duty() {
        return officer_on_Duty;
    }

    public void setOfficer_on_Duty(String officer_on_Duty) {
        this.officer_on_Duty = officer_on_Duty;
    }
